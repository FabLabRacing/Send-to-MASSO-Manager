#!/usr/bin/env python3
"""
Send-to-MASSO Manager - HMI-style Tkinter uploader (v1.8)
...
APP_NAME = "Send-to-MASSO Manager v1.8.0"
...
class SendGui:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(top, text="v1.8.1  •  first usability series version", style="Version.TLabel").pack(side="right", pady=(9, 0))
        ...
        self.log("V1.8.0 HMI GUI loaded. Batch queue build.")
