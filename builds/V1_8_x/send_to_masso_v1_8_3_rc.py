#!/usr/bin/env python3
"""
TURBO Send-to-MASSO Manager - HMI-style Tkinter uploader (v1.8.3 Release Candidate)
...
APP_NAME = "TURBO Send-to-MASSO Manager v1.8.3 RC"
...
class TurboSendGui:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(top, text="v1.8.3 RC  •  queue + QR + FabLab Racing branding", style="Version.TLabel").pack(side="right", pady=(9, 0))
    ...
    def _load_brand_logo(self) -> None:
        ...
        try:
            ...
            self.logo_label.configure(text="FABLAB RACING")
        ...
        for path in candidates:
            ...
            try:
                ...
                self.logo_note_label.configure(text="FabLab Racing branding loaded")
                return
            except Exception as exc:
                self.logo_label.configure(text="FABLAB RACING")
