#!/usr/bin/env python3
"""
TURBO Send-to-MASSO Manager - HMI-style Tkinter uploader (v1.8.4 Release Candidate)
...
APP_NAME = "TURBO Send-to-MASSO Manager v1.8.4 RC"
...
class TurboSendGui:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(top, text="v1.8.4 RC  •  queue + QR + FabLab Racing branding", style="Version.TLabel").pack(side="right", pady=(9, 0))
        ...
        self.log("V1.8.4 RC HMI GUI loaded. Release-candidate layout cleanup build.")
    ...
    def _big_status_box(self, parent: tk.Widget, column: int, label: str, var: tk.StringVar) -> None:
        box = ttk.Frame(parent, style="SubPanel.TFrame", padding=(12, 10))
