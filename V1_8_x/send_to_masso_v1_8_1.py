#!/usr/bin/env python3
"""
Send-to-MASSO Manager - HMI-style Tkinter uploader (v1.8.1)
...
Notes:
- This is a shop test build, not polished production software.
...
APP_NAME = "Send-to-MASSO Manager v1.8.1"
...
class SendGui:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(top, text="v1.8.1  •  Batch queue + QR-code build", style="Version.TLabel").pack(side="right", pady=(9, 0))
